classdef Violin < handle
    ...
    properties (Dependent=true)
        ...
        ShowNotches % whether to show notch indicators
        ShowMean    % whether to show mean indicator
        DataColor   % BV: color of data points
        DataAlpha   % BV: alpha of data points
    end
    ...
    methods
        function obj = Violin(data, pos, varargin)
            ...
            % BV
            if not(isempty(args.DataColor))
                obj.DataColor = args.DataColor;
            else
                obj.DataColor = obj.ScatterPlot.CData;
            end
        ...
        % BV: set data points independently
    ...
    methods (Access=private)
        function results = checkInputs(obj, data, pos, varargin)
            ...
            % BV:
            p.addParameter('DataColor',[],iscolor)
